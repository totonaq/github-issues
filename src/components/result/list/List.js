...
class List extends Component {
	...
	constructor(props) {
		...
		this.getTooltipHeight = this.getTooltipHeight.bind(this);
	...
	onTooltipMouseOver(target) {
		// if .ListItem-content-data_author is being hovered
		if (target.dataset) {
		...
		return(
			<div>
				...
				{this.state.isTooltipVisible && 
					<AuthorTooltip
						getTooltipHeight={this.getTooltipHeight}
